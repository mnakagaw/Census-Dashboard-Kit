...
export async function loadSourceCatalog(root = defaultRoot) {
  ...
  const [common, registry, jicaPriority, prioritySourcePreflight] = await Promise.all([
    readJson(base, COMMON_PATH), readJson(base, COUNTRY_PATH), readJson(base, JICA_PRIORITY_PATH), readJson(base, JICA_PRIORITY_SOURCE_PATH),
  ]);

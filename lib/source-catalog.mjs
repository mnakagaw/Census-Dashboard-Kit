...
export async function loadSourceCatalog(root = defaultRoot) {
  ...
  const [common, registry, worldRegistry, worldSourcePreflight, jicaPriority, prioritySourcePreflight, americasRecipes] = await Promise.all([
    ...
    readJson(base, AMERICAS_RECIPE_PATH),
  ]);
  ...
  return {
    version: '1.1',
    as_of: [common.as_of, registry.as_of, worldRegistry.as_of, worldSourcePreflight.as_of, jicaPriority.as_of, americasRecipes.as_of].sort().at(-1),

...
選択地域について、その目次、法的根拠、取得済み統計、資料、出典、不足欄を含む編集可能なDOCXを必ず生成してください。Wordの文書名・先頭タイトルは「Diagnóstico para el Plan de Desarrollo Municipal」とし、少なくともDiagnóstico Territorial、人口ピラミッド、テーマ別の取得済み最新版と出典年、法規・国勢調査・国際機関sourceの一覧を含めてください。計画書の下書きや政府様式を名乗る表現は使わず、一般的な8章構成を国別確認なしに使わないでください。

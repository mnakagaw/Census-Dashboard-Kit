...
export function planDocxBytes(dataset,territoryId,period) {
  ...
  body.push(paragraph('Document control','Heading1',{keep:true}),table([['Item','Value'],['Country and area',`${dataset.country.name} · ${area.name}`],['Dataset edition',dataset.generated_at],['Index basis checked',template.verified_at],['Document type',diagnosticTitle]],[2600,6500]));

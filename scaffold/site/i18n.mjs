...
const COPY={
  ...
  'Municipal development planning diagnostic':['Diagnóstico para la planificación del desarrollo municipal','市開発計画用の診断資料'],
  'Download municipal planning diagnostic (Word)':['Descargar diagnóstico municipal (Word)','市開発計画用の診断資料（Word）'],
